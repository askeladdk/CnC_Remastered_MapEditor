...
namespace Steamworks {
    ...
    public class gameserveritem_t {
        public string GetGameDir() => Encoding.UTF8.GetString(this.m_szGameDir, 0, System.Array.IndexOf<byte>(this.m_szGameDir, 0));

        public void SetGameDir(string dir) => this.m_szGameDir = Encoding.UTF8.GetBytes(dir + '\0');

        public string GetMap() => Encoding.UTF8.GetString(this.m_szMap, 0, System.Array.IndexOf<byte>(this.m_szMap, 0));

        public void SetMap(string map) => this.m_szMap = Encoding.UTF8.GetBytes(map + '\0');

        public string GetGameDescription() => Encoding.UTF8.GetString(this.m_szGameDescription, 0, System.Array.IndexOf<byte>(this.m_szGameDescription, 0));
        ...
        public string GetServerName() {
            ...
            if(this.m_szServerName[0] == 0)
                ...
                return Encoding.UTF8.GetString(this.m_szServerName, 0, System.Array.IndexOf<byte>(this.m_szServerName, 0));
        }

        public void SetServerName(string name) => this.m_szServerName = Encoding.UTF8.GetBytes(name + '\0');

        public string GetGameTags() => Encoding.UTF8.GetString(this.m_szGameTags, 0, System.Array.IndexOf<byte>(this.m_szGameTags, 0));
