...
namespace Steamworks {
    ...
    public struct PartyBeaconID_t : System.IEquatable<PartyBeaconID_t>, System.IComparable<PartyBeaconID_t> {
        ...
        public override bool Equals(object other) => other is PartyBeaconID_t && this == (PartyBeaconID_t)other;

        public override int GetHashCode() => this.m_PartyBeaconID.GetHashCode();

        public static bool operator ==(PartyBeaconID_t x, PartyBeaconID_t y) => x.m_PartyBeaconID == y.m_PartyBeaconID;
        ...
        public bool Equals(PartyBeaconID_t other) => this.m_PartyBeaconID == other.m_PartyBeaconID;
