...
namespace Steamworks {
    ...
    internal static class CSteamAPIContext {
        ...
        internal static IntPtr GetSteamClient() => m_pSteamClient;
        internal static IntPtr GetSteamUser() => m_pSteamUser;
        internal static IntPtr GetSteamFriends() => m_pSteamFriends;
        internal static IntPtr GetSteamUtils() => m_pSteamUtils;
        internal static IntPtr GetSteamMatchmaking() => m_pSteamMatchmaking;
        internal static IntPtr GetSteamUserStats() => m_pSteamUserStats;
        internal static IntPtr GetSteamApps() => m_pSteamApps;
        internal static IntPtr GetSteamMatchmakingServers() => m_pSteamMatchmakingServers;
        internal static IntPtr GetSteamNetworking() => m_pSteamNetworking;
        internal static IntPtr GetSteamRemoteStorage() => m_pSteamRemoteStorage;
        internal static IntPtr GetSteamScreenshots() => m_pSteamScreenshots;
        internal static IntPtr GetSteamGameSearch() => m_pSteamGameSearch;
        internal static IntPtr GetSteamHTTP() => m_pSteamHTTP;
        internal static IntPtr GetSteamController() => m_pController;
        internal static IntPtr GetSteamUGC() => m_pSteamUGC;
        internal static IntPtr GetSteamAppList() => m_pSteamAppList;
        internal static IntPtr GetSteamMusic() => m_pSteamMusic;
        internal static IntPtr GetSteamMusicRemote() => m_pSteamMusicRemote;
        internal static IntPtr GetSteamHTMLSurface() => m_pSteamHTMLSurface;
        internal static IntPtr GetSteamInventory() => m_pSteamInventory;
        internal static IntPtr GetSteamVideo() => m_pSteamVideo;
        internal static IntPtr GetSteamParentalSettings() => m_pSteamParentalSettings;
        internal static IntPtr GetSteamInput() => m_pSteamInput;
        internal static IntPtr GetSteamParties() => m_pSteamParties;
        internal static IntPtr GetSteamRemotePlay() => m_pSteamRemotePlay;
    ...
    internal static class CSteamGameServerAPIContext {
        ...
        internal static IntPtr GetSteamClient() => m_pSteamClient;
        internal static IntPtr GetSteamGameServer() => m_pSteamGameServer;
        internal static IntPtr GetSteamUtils() => m_pSteamUtils;
        internal static IntPtr GetSteamNetworking() => m_pSteamNetworking;
        internal static IntPtr GetSteamGameServerStats() => m_pSteamGameServerStats;
        internal static IntPtr GetSteamHTTP() => m_pSteamHTTP;
        internal static IntPtr GetSteamInventory() => m_pSteamInventory;
        internal static IntPtr GetSteamUGC() => m_pSteamUGC;
        internal static IntPtr GetSteamApps() => m_pSteamApps;
