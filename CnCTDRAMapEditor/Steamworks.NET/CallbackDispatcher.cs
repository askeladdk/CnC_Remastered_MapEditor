...
namespace Steamworks {
    ...
    public sealed class Callback<T> : IDisposable {
        ...
        public void Register(DispatchDelegate func) {
            ...
            if((this.m_CCallbackBase.m_nCallbackFlags & CCallbackBase.k_ECallbackFlagsRegistered) == CCallbackBase.k_ECallbackFlagsRegistered) {
                this.Unregister();
            }
        ...
        public void SetGameserverFlag() => this.m_CCallbackBase.m_nCallbackFlags |= CCallbackBase.k_ECallbackFlagsGameServer;
...
#endif
            IntPtr pvParam) {
            this.m_hAPICall = SteamAPICall_t.Invalid; // Caller unregisters for us
