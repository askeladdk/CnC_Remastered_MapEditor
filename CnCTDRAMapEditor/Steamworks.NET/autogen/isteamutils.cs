...
namespace Steamworks {
    public static class SteamUtils {
        ...
        public static bool GetEnteredGamepadTextInput(out string pchText, uint cchText) {
            ...
            var ret = NativeMethods.ISteamUtils_GetEnteredGamepadTextInput(CSteamAPIContext.GetSteamUtils(), pchText2, cchText);
        ...
        public static int FilterText(out string pchOutFilteredText, uint nByteSizeOutFilteredText, string pchInputMessage, bool bLegalOnly) {
            ...
            using(var pchInputMessage2 = new InteropHelp.UTF8StringHandle(pchInputMessage)) {
                var ret = NativeMethods.ISteamUtils_FilterText(CSteamAPIContext.GetSteamUtils(), pchOutFilteredText2, nByteSizeOutFilteredText, pchInputMessage2, bLegalOnly);
