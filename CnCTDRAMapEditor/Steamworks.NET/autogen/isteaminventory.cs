    ...
    public static class SteamInventory {
        ...
        public static bool GetResultItemProperty(SteamInventoryResult_t resultHandle, uint unItemIndex, string pchPropertyName, out string pchValueBuffer, ref uint punValueBufferSizeOut) {
            ...
            using(var pchPropertyName2 = new InteropHelp.UTF8StringHandle(pchPropertyName)) {
                var ret = NativeMethods.ISteamInventory_GetResultItemProperty(CSteamAPIContext.GetSteamInventory(), resultHandle, unItemIndex, pchPropertyName2, pchValueBuffer2, ref punValueBufferSizeOut);
        ...
        public static bool GetItemDefinitionProperty(SteamItemDef_t iDefinition, string pchPropertyName, out string pchValueBuffer, ref uint punValueBufferSizeOut) {
            ...
            var pchValueBuffer2 = Marshal.AllocHGlobal((int)punValueBufferSizeOut);
            using(var pchPropertyName2 = new InteropHelp.UTF8StringHandle(pchPropertyName)) {
                var ret = NativeMethods.ISteamInventory_GetItemDefinitionProperty(CSteamAPIContext.GetSteamInventory(), iDefinition, pchPropertyName2, pchValueBuffer2, ref punValueBufferSizeOut);
                pchValueBuffer = ret ? InteropHelp.PtrToStringUTF8(pchValueBuffer2) : null;
                Marshal.FreeHGlobal(pchValueBuffer2);
                return ret;
            }
