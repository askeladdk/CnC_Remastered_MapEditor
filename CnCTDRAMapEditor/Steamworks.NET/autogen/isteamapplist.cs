...
namespace Steamworks {
    public static class SteamAppList {
        ...
        public static int GetAppName(AppId_t nAppID, out string pchName, int cchNameMax) {
            InteropHelp.TestIfAvailableClient();
            var pchName2 = Marshal.AllocHGlobal(cchNameMax);
            var ret = NativeMethods.ISteamAppList_GetAppName(CSteamAPIContext.GetSteamAppList(), nAppID, pchName2, cchNameMax);
        ...
        public static int GetAppInstallDir(AppId_t nAppID, out string pchDirectory, int cchNameMax) {
            InteropHelp.TestIfAvailableClient();
            var pchDirectory2 = Marshal.AllocHGlobal(cchNameMax);
            var ret = NativeMethods.ISteamAppList_GetAppInstallDir(CSteamAPIContext.GetSteamAppList(), nAppID, pchDirectory2, cchNameMax);
