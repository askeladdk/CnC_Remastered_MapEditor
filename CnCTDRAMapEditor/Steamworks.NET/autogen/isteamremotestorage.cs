...
namespace Steamworks {
    public static class SteamRemoteStorage {
        ...
        public static bool GetUGCDetails(UGCHandle_t hContent, out AppId_t pnAppID, out string ppchName, out int pnFileSizeInBytes, out CSteamID pSteamIDOwner) {
            InteropHelp.TestIfAvailableClient();
            var ret = NativeMethods.ISteamRemoteStorage_GetUGCDetails(CSteamAPIContext.GetSteamRemoteStorage(), hContent, out pnAppID, out var ppchName2, out pnFileSizeInBytes, out pSteamIDOwner);
