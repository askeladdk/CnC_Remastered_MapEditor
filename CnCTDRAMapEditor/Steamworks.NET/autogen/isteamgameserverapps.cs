...
namespace Steamworks {
    public static class SteamGameServerApps {
        ...
        public static bool BGetDLCDataByIndex(int iDLC, out AppId_t pAppID, out bool pbAvailable, out string pchName, int cchNameBufferSize) {
            ...
            var ret = NativeMethods.ISteamApps_BGetDLCDataByIndex(CSteamGameServerAPIContext.GetSteamApps(), iDLC, out pAppID, out pbAvailable, pchName2, cchNameBufferSize);
        ...
        public static bool GetCurrentBetaName(out string pchName, int cchNameBufferSize) {
            InteropHelp.TestIfAvailableGameServer();
            var pchName2 = Marshal.AllocHGlobal(cchNameBufferSize);
            var ret = NativeMethods.ISteamApps_GetCurrentBetaName(CSteamGameServerAPIContext.GetSteamApps(), pchName2, cchNameBufferSize);
            pchName = ret ? InteropHelp.PtrToStringUTF8(pchName2) : null;
            Marshal.FreeHGlobal(pchName2);
            return ret;
        }
        ...
        public static uint GetAppInstallDir(AppId_t appID, out string pchFolder, uint cchFolderBufferSize) {
            ...
            var ret = NativeMethods.ISteamApps_GetAppInstallDir(CSteamGameServerAPIContext.GetSteamApps(), appID, pchFolder2, cchFolderBufferSize);
        ...
        public static int GetLaunchCommandLine(out string pszCommandLine, int cubCommandLine) {
            ...
            var ret = NativeMethods.ISteamApps_GetLaunchCommandLine(CSteamGameServerAPIContext.GetSteamApps(), pszCommandLine2, cubCommandLine);
